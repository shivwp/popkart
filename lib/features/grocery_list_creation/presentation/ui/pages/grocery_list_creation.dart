...
import 'package:popkart/features/grocery_list_creation/presentation/ui/pages/grocery_list_creation_controller.dart';
...
Get.put(getIt<GroceryListCreationController>());
    return GetBuilder<GroceryListCreationController>(builder: (controller) {
      return Scaffold(
