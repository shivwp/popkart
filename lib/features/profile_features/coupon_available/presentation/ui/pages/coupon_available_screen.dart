...
import 'package:popkart/features/profile_features/coupon_available/presentation/ui/pages/coupon_available_controller.dart';
...
class _CouponAvailablePageState extends State<CouponAvailablePage> {
  ...
  Widget build(BuildContext context) {
    Get.put(getIt<CouponAvailableController>());
    return GetBuilder<CouponAvailableController>(builder: (controller) {
      return Scaffold(
        appBar: AppBar(
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                controller
                                    .couponResponse.couponlist![index].code
                                    .toString(),
                                style: labelstyle,
                              ),
                              Text(
