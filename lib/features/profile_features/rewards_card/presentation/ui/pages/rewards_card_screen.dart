...
import 'package:popkart/features/profile_features/rewards_card/presentation/ui/pages/rewards_card_controller.dart';
...
class _RewardsCardPageState extends State<RewardsCardPage> {
  ...
  Widget build(BuildContext context) {
    Get.put(getIt<RewardsCardController>());
    return GetBuilder<RewardsCardController>(builder: (controller) {
      return Scaffold(
        appBar: AppBar(
